//this file handles the different choices available from the inquirer prompt by providing front-end functions that display data or add new data with the help of another file (database.js)
...
async function updateEmployeeRole() {
    try {
        ...
        const employeeOptions = currentEmployees.rows.map(row => ({ name: row.first_name + ' ' + row.last_name, value: row.id }))
        ...
        await updateEmployeeRoleToDatabase(employeeInfo.employeeId, employeeInfo.newRoleId);
...
//             ])
//             //call updateEmployeeRole function with prompt answers after await
//             await updateEmployeeRole(employeeInfo.employeeId, employeeInfo.newRoleId);
//             console.log("employee role updated successfully");
