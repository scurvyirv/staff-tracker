...
async function addEmployee() {
    try {
        ...
        //call addEmployeeToDatabase function to update the employee list
...
class AddDepartment extends Option {
    async render() {
        try {
            ...
            //call addDepartment function to update the department list
            await addDepartment(newRole.title, newRole.department, newRole.salary);
            console.log("New role added successfully");
